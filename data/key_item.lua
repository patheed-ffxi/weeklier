...
local keyItems = {
    ...
    OVERDUE_BOOK_NOTIFICATIONS_EARLY_BIRD    = 10, -- Used in Early Bird Catches the Bookworm (Art for Everyone)
    ...
    COLD_MEDICINE                            = 147,
    AMAURAS_FORMULA                          = 148,
    OVERDUE_BOOK_NOTIFICATION_CHASING_TALES  = 149, -- Used in Chasing Tales (A Song of Love)
    ...
    MOGHANCEMENT_FISHING_ITEMS               = 534,
    ...
    MOGHANCEMENT_MANDRAGORA_MANIA            = 543,
    ...
    SUPPLY_ORDER                             = 945,
    GRIMOIRE                                 = 946,
    ZONPA_ZIPPAS_ALL_PURPOSE_PUTTY           = 947,
    SCOOP_DEDICATED_LINKPEARL                = 948,
    FIREPOWER_CASE                           = 949,
    CHARRED_PROPELLER                        = 950,
    PIECE_OF_SHATTERED_LUMBER                = 951,
    OXIDIZED_PLATE                           = 952,
    PIECE_OF_KIONITE                         = 953,
    RANPI_MONPI_SPECIALTY                    = 954,
    CULINARY_KNIFE                           = 955,
    FIREBLOSSOM                              = 956,
    ...
    LEATHER_BOUND_BOOK                       = 971,
    LYNX_PELT                                = 972,
    WYATTS_PROPOSAL                          = 973,
    FORT_KEY                                 = 974,
    ULBRECHTS_SEALED_LETTER                  = 975,
    SCHULTZS_SEALED_LETTER                   = 976,
    ...
    BEASTMAN_CONFEDERATE_CRATE               = 986,
    MILITARY_SCRIP                           = 987,
    SILVERMINE_KEY                           = 988,
    RED_PRIZE_BALLOON                        = 989,
    BLUE_PRIZE_BALLOON                       = 990,
    GREEN_PRIZE_BALLON                       = 991,
    ...
    -- MAGIAN_MOOGLEHOOD_MISSIVE6 is invalid
    ...
    MOG_KUPON_AW_VGR                         = 1849,
    MOG_KUPON_AW_VGRII                       = 1850,
    MOG_KUPON_W_PULSE                        = 1851,
    MOG_KUPON_I_STONE                        = 1852,
    MOG_KUPON_AW_GFIII                       = 1853,
    ...
    AGED_UNDYING_NAAKUAL_CREST               = 2165,
    ...
    REDOUBLED_CHOP                           = 2242,
    CONSERVATIVE_CHOP                        = 2243,
    REDOUBLED_SMASH                          = 2244,
    CONSERVATIVE_SMASH                       = 2245,
    REDOUBLED_SLICE                          = 2246,
    CONSERVATIVE_SLICE                       = 2247,
    ...
    MHMU_TREATISE_ON_MINERALS                = 2431,
    ...
    PEPPE_ALEPPES_SUPERLATIVE_TONIC          = 2547,
    ...
    MOG_KUPON_I                              = 2559,
    MOG_KUPON_W_JOB                          = 2560,
    MOG_KUPON_I_MAT                          = 2561,
    MOG_KUPON_W_DEIII                        = 2562,
    MOG_KUPON_AW_MIS                         = 2563,
    ...
    VELKK_FETISH                             = 2606,
    YMMR_ULVIDS_NECKLACE                     = 2607,
    IGNOR_MNTS_BRACELET                      = 2608,
    DURS_VIKES_EARRING                       = 2609,
    TRYL_WUJS_BELT                           = 2610,
    PAIR_OF_LIIJ_VOKS_GLOVES                 = 2611,
    GRAMK_DROOGS_CIRCLET                     = 2612,
    ...
    SIRENS_PLUME                             = 2847,
    MOGLIFICATION_RESIST_SLEEP               = 2848,
    ...
    MAUVE_WRISTED_GOMBERRYS_KNIFE            = 2993,
    ...
    ERINYSS_BEAK                             = 3018,
    MOG_KUPON_AW_GFII                        = 3019,
    MOG_KUPON_AW_GF                          = 3020,
    MOG_KUPON_AW_UWIII                       = 3021,
    MOG_KUPON_AW_UWII                        = 3022,
    MOG_KUPON_AW_UW                          = 3023,
    MOG_KUPON_A_AB                           = 3024,
    MOG_KUPON_AW_COS                         = 3025,
    ...
    MOG_KUPON_W_EMI                          = 3056,
    MOG_KUPON_A_EMI                          = 3057,
    MOG_KUPON_W_SRW                          = 3058,
    MOG_KUPON_W_SCC                          = 3059,
    MOG_KUPON_A_SYW                          = 3060,
    MOG_KUPON_W_ASRW                         = 3061,
    MOG_KUPON_W_ASCC                         = 3062,
    MOG_KUPON_A_ASYW                         = 3063,
    MOG_KUPON_W_R119                         = 3064,
    MOG_KUPON_W_M119                         = 3065,
    MOG_KUPON_W_E119                         = 3066,
    MOG_KUPON_W_A119                         = 3067,
    MOG_KUPON_AW_GEIV                        = 3068,
    ...
    MOG_KUPON_A_OMII                         = 3139,
    MOG_KUPON_I_AF119                        = 3140,
    MOG_KUPON_AW_OM                          = 3141,
    FUS_BEAD                                 = 3142,
    KEIS_BEAD                                = 3143,
    KYOUS_BEAD                               = 3144,
    GINS_BEAD                                = 3145,
    ...
    ANCIENT_MELODY_G                         = 3151,
    ANCIENT_MELODY_A                         = 3152,
    AFTER_PARTY_PASS                         = 3153,
    REASSEMBLING_TECHNIQUE                   = 3154,
    MEMORY_GEM                               = 3155,
    EMPTY_HOURGLASS                          = 3156,
    FILLED_MEMORY_GEM                        = 3157,
    ELVAAN_MASK_OF_DARKNESS                  = 3158,
    ELVAAN_MASK_OF_LIGHT                     = 3159,
    GALKA_MASK_OF_DARKNESS                   = 3160,
    GALKA_MASK_OF_LIGHT                      = 3161,
    TARUTARU_MASK_OF_DARKNESS                = 3162,
    TARUTARU_MASK_OF_LIGHT                   = 3163,
    MITHRA_MASK_OF_DARKNESS                  = 3164,
    MITHRA_MASK_OF_LIGHT                     = 3165,
    BROKEN_FLYING_MACHINE                    = 3166,
    LEVITATION_DEVICE                        = 3167,
    WHIRRING_ENGINE                          = 3168,
    MOG_KUPON_W_RMEA                         = 3169,
    DEED_VOUCHER                             = 3170,
    DEED_VOUCHER_PLUS_1_HEAD                 = 3171,
    DEED_VOUCHER_PLUS_1_CHEST                = 3172,
    DEED_VOUCHER_PLUS_1_HANDS                = 3173,
    DEED_VOUCHER_PLUS_1_LEGS                 = 3174,
    DEED_VOUCHER_PLUS_1_FEET                 = 3175,
    DEED_VOUCHER_PLUS_2_HEAD                 = 3176,
    DEED_VOUCHER_PLUS_2_CHEST                = 3177,
    DEED_VOUCHER_PLUS_2_HANDS                = 3178,
    DEED_VOUCHER_PLUS_2_LEGS                 = 3179,
    DEED_VOUCHER_PLUS_2_FEET                 = 3180,
    TENTACLE_TOUCHING_TICKET                 = 3181,
    INVITATION_FROM_EXCENMILLE               = 3182,
    INVITATION_FROM_NAJI                     = 3183,
    INVITATION_FROM_KUPIPI                   = 3184,
    STYGIAN_PACT_PHANTOM_GEM                 = 3185,
    CHAMPION_PHANTOM_GEM                     = 3186,
    DIVINE_PHANTOM_GEM                       = 3187,
    MAIDEN_PHANTOM_GEM                       = 3188,
    INERT_GEOMANCY_BELL                      = 3189,
    FISTFUL_OF_FAMILIAR_SOIL                 = 3190,
    SHEET_OF_MAPITOTO_TUNES                  = 3191,
    MANDRAGORA_SPROUTLING_MEMENTO            = 3192,
    MANDRAGORA_MEMENTO                       = 3193,
    ELDER_MANDRAGORA_MEMENTO                 = 3194,
    LYCOPODIUM_MEMENTO                       = 3195,
    AKE_OME_MEMENTO                          = 3196,
    ADENIUM_MEMENTO                          = 3197,
    ELDER_ADENIUM_MEMENTO                    = 3198,
    KORRIGAN_MEMENTO                         = 3199,
    PACHYPODIUM_MEMENTO                      = 3200,
    CITRULLUS_MEMENTO                        = 3201,
    CHEER_MANDRAGORA_SPROUTLING              = 3202,
    CHEER_MANDRAGORA                         = 3203,
    CHEER_ELDER_MANDRAGORA                   = 3204,
    CHEER_LYCOPODIUM                         = 3205,
    CHEER_AKE_OME                            = 3206,
    CHEER_ADENIUM                            = 3207,
    CHEER_ELDER_ADENIUM                      = 3208,
    CHEER_KORRIGAN                           = 3209,
    CHEER_PACHYPODIUM                        = 3210,
    CHEER_CITRULLUS                          = 3211,
    MOGLOPHONE                               = 3212,
    DEED_TOKEN                               = 3213,
    DEED_TOKEN_PLUS_1_HEAD                   = 3214,
    DEED_TOKEN_PLUS_1_CHEST                  = 3215,
    DEED_TOKEN_PLUS_1_HANDS                  = 3216,
    DEED_TOKEN_PLUS_1_LEGS                   = 3217,
    DEED_TOKEN_PLUS_1_FEET                   = 3218,
    DEED_TOKEN_PLUS_2_HEAD                   = 3219,
    DEED_TOKEN_PLUS_2_CHEST                  = 3220,
    DEED_TOKEN_PLUS_2_HANDS                  = 3221,
    DEED_TOKEN_PLUS_2_LEGS                   = 3222,
    DEED_TOKEN_PLUS_2_FEET                   = 3223,
    PRIMER_ON_MARTIAL_TECHNIQUES             = 3224,
    ...
    INFORMATION_ON_XEVIOSO                   = 3247,
    INFORMATION_ON_NGAI                      = 3248,
    INFORMATION_ON_KALUNGA                   = 3249,
    INFORMATION_ON_ONGO                      = 3250,
    INFORMATION_ON_MBOZE                     = 3251,
    INFORMATION_ON_AREBATI                   = 3252,
    INFORMATION_ON_BUMBA                     = 3253,
    ORCISH_BATTLE_PLAN                       = 3254,
    QUEMARICONDS_REPORT                      = 3255,
    SOLIDAGO_FLOWER                          = 3256,
    MISSIVE_TO_ALTENNIA                      = 3257,
    CARMINE_SWALLOWS_MAP                     = 3258,
    ...
    ASPIRANTS_CANTEEN                        = 3269,
    COURAGEOUS_WARRIORS_SHARD                = 3270,
    DEDICATED_MONKS_SHARD                    = 3271,
    STALWART_WHITE_MAGES_SHARD               = 3272,
    STORIED_BLACK_MAGES_SHARD                = 3273,
    PEERLESS_RED_MAGES_SHARD                 = 3274,
    REFINED_THIEFS_SHARD                     = 3275,
    ELEGANT_PALADINS_SHARD                   = 3276,
    STOIC_DARK_KNIGHTS_SHARD                 = 3277,
    FERVENT_BEASTMASTERS_SHARD               = 3278,
    DISTINGUISHED_BARDS_SHARD                = 3279,
    RELENTLESS_RANGERS_SHARD                 = 3280,
    INIMITABLE_SAMURAIS_SHARD                = 3281,
    VALIANT_NINJAS_SHARD                     = 3282,
    HEROIC_DRAGOONS_SHARD                    = 3283,
    LEARNED_SUMMONERS_SHARD                  = 3284,
    UNRIVALLED_BLU_MAGES_SHARD               = 3285,
    UNPARALLELED_CORSAIRS_SHARD              = 3286,
    DIGNIFIED_PUPPETMASTERS_SHARD            = 3287,
    GRACEFUL_DANCERS_SHARD                   = 3288,
    CLEVER_SCHOLARS_SHARD                    = 3289,
    DYNAMIC_GEOMANCERS_SHARD                 = 3290,
    ARDENT_RUNE_FENCERS_SHARD                = 3291,
    DISTORTED_FRAGMENT                       = 3292,
    MEMORIAN_THE_MAGICKED_DOLL               = 3293,
    DEPLETED_MEMORIAN                        = 3294,
    TRIONS_DIRECTIVE                         = 3295,
    EMBER_ENCRUSTED_ORICHALCUM               = 3296,
    CLOTH_LINED_BASKET                       = 3297,
    MAP_TO_THE_WOMANS_HOME                   = 3298,
    MAATS_PILLOW                             = 3299,
    SHINY_RAKAZNARIAN_PLATE                  = 3300,
    DULL_RAKAZNARIAN_PLATE                   = 3301,
    LIBER_DAEMONIUM                          = 3302,
    BRONZE_HUED_TAG                          = 3303,
    SILVER_KNIFE_MEMBERSHIP_CARD             = 3304,
    COURAGEOUS_WARRIORS_SOUL                 = 3305,
    DEDICATED_MONKS_SOUL                     = 3306,
    STALWART_WHITE_MAGES_SOUL                = 3307,
    STORIED_BLACK_MAGES_SOUL                 = 3308,
    PEERLESS_RED_MAGES_SOUL                  = 3309,
    REFINED_THIEFS_SOUL                      = 3310,
    ELEGANT_PALADINS_SOUL                    = 3311,
    STOIC_DARK_KNIGHTS_SOUL                  = 3312,
    FERVENT_BEASTMASTERS_SOUL                = 3313,
    DISTINGUISHED_BARDS_SOUL                 = 3314,
    RELENTLESS_RANGERS_SOUL                  = 3315,
    INIMITABLE_SAMURAIS_SOUL                 = 3316,
    VALIANT_NINJAS_SOUL                      = 3317,
    HEROIC_DRAGOONS_SOUL                     = 3318,
    LEARNED_SUMMONERS_SOUL                   = 3319,
    UNRIVALLED_BLU_MAGES_SOUL                = 3320,
    UNPARALLELED_CORSAIRS_SOUL               = 3321,
    DIGNIFIED_PUPPETMASTERS_SOUL             = 3322,
    GRACEFUL_DANCERS_SOUL                    = 3323,
    CLEVER_SCHOLARS_SOUL                     = 3324,
    DYNAMIC_GEOMANCERS_SOUL                  = 3325,
    ARDENT_RUNE_FENCERS_SOUL                 = 3326,
    URAN_MAFRANS_ORB                         = 3327,
    RUSPIXS_PLATE                            = 3328,
    SHEET_OF_ANCIENT_BATTLE_TUNES            = 3329,
    SHEET_OF_DESTINY_DESTROYER_TUNES         = 3330,
    SHEET_OF_CHARACTER_SELECTION_TUNES       = 3331,
    SHEET_OF_STARLIGHT_TUNES                 = 3332,
    DESPAIRING_PSYCHE                        = 3333,
    SUFFERING_PSYCHE                         = 3334,
    ANGUISHED_PSYCHE                         = 3335,
    RANCOROUS_PSYCHE                         = 3336,
    DETERMINED_PSYCHE                        = 3337,
    RAEBRIMMS_MEMENTO                        = 3338,
    VIAL_OF_CHAOSS_BLOOD                     = 3339,
    MOG_KUPON_A_SAP                          = 3340,
    MOG_KUPON_A_JAD                          = 3341,
    MOG_KUPON_A_RUB                          = 3342,
    -- NULL ENTRY                            = 3343,
